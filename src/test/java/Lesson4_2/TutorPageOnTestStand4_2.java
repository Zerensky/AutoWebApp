...
public class TutorPageOnTestStand4_2 {

    private WebDriver driver;
    private Lesson4_2.LoginPage loginPage;
    private Lesson4_2.MainPage mainPage;
    ...
    private static final String birthDateInput = "12.21.2012";
    private static final String birthDateDisplay = "21.12.2012";
    ...
    public void groupAddingTest()  {
        ...
        Lesson4_2.MainPage mainPage = Selenide.page(Lesson4_2.MainPage.class);
    ...
    private void getScreen() {
        Selenide.screenshot("Lesson4_2_" + System.currentTimeMillis());
    }
